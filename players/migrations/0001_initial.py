    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('players_name', models.CharField(max_length=150, verbose_name='Имя')),
                ('slug', models.SlugField(max_length=255, unique=True, verbose_name='url')),
                ('birthdate', models.DateField(blank=True, null=True, verbose_name='Год Рождения')),
                ...
                ('price', djmoney.models.fields.MoneyField(decimal_places=2, default_currency='USD', max_digits=14, verbose_name='Цена в Transfermarkt')),
                ('foot', models.CharField(choices=[('RIGHT', 'правая'), ('LEFT', 'левая'), ('BOTHS', 'обе')], max_length=150, verbose_name='Рабочая нога')),
                ('chempionship', models.CharField(max_length=150, verbose_name='Чемпионат')),
                ('matches_chempionship', models.IntegerField(default=0, verbose_name='Матчи в чемпионате')),
                ('goals_chempionship', models.IntegerField(default=0, verbose_name='Голы в чемпионате')),
                ('assists', models.IntegerField(default=0, verbose_name='Голевые в чемпионате')),
            ],
            options={
